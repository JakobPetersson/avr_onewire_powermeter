#ifndef ow_slave_DS2423_attiny25_h
#define ow_slave_DS2423_attiny25_h

/*
 * Device: ATtiny25
 * 1-Wire pin - PB2 (Pin 7)
 * CounterA   - PB3 (Pin 2)
 * CounterB   - PB4 (Pin 3)
 *
 */
...
#define OW_PORTN (1<<PINB2)							// 1-Wire port number
#define OW_PIN PINB 								// 1-Wire input register
#define OW_PINN (1<<PINB2)							// 1-Wire pin number
